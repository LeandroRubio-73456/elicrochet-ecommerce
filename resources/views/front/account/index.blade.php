...
<div class="row">
    ...
    <div class="col-md-6 mb-4">
        <div class="card shadow-sm border-0 h-100">
                ...
                @if($recentOrders->count() > 0)
                    <div class="list-group list-group-flush mt-3">
                        @foreach($recentOrders as $order)
                            <a href="{{ route('account.orders.show', $order) }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center px-0">
                                <div>
            ...
            <div class="card-footer bg-white border-top-0 text-end">
                <a href="{{ route('account.orders.index') }}" class="text-decoration-none f-14 fw-bold">Ver todos los pedidos <i class="ti ti-arrow-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 mb-4">
        <div class="card shadow-sm border-0 h-100">
            ...
            <div class="card-footer bg-white border-top-0 text-end">
                <a href="{{ route('account.profile.edit') }}" class="btn btn-outline-primary btn-sm">Editar Datos</a>
            </div>
        </div>
    </div>
</div>
