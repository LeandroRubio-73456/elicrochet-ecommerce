...
<!-- Shop Header / Breadcrumb Minimalista -->
...
<section class="product-section">
    <div class="container">
        <div class="row g-5">
                ...
                <div class="product-info">
                    ...
                    @if($product->isAvailable())
                        ...
                        <form action="{{ route('cart.add', $product->slug) }}" method="POST" class="add-to-cart-form">
                            @csrf
                            <div class="quantity-cart-wrapper d-flex gap-3 flex-wrap">
                                <!-- Quantity Selector -->
                                ...
                                <!-- Add to Cart Button -->
                                <button type="submit" class="btn btn-primary btn-add-to-cart p-2">
                                    <i class="ti ti-shopping-cart-plus me-md-2"></i>
                                    <span class="d-none d-md-inline">Añadir al carrito</span>
                                </button>
                            </div>
                        </form>
            ...
            <!-- Product Tabs (Integrated) -->
            <div class="col-12 mt-5">
                <div class="tabs-wrapper">
                    <!-- Tab Navigation -->
                    <ul class="nav nav-tabs tabs-nav" id="productTab" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link active px-2" id="desc-tab" data-bs-toggle="tab" data-bs-target="#desc" type="button">
                                Descripción
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link px-2" id="specs-tab" data-bs-toggle="tab" data-bs-target="#specs" type="button">
                                Especificaciones
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link px-2" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#reviews" type="button">
                                Opiniones
                            </button>
                        </li>
                    </ul>
...
<section class="related-products-section section-padding bg-white">
    <div class="container">
