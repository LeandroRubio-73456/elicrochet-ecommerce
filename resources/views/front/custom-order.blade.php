                    ...
                    <form action="{{ route('custom-order.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="customer_name" id="customer_name" class="form-control" value="{{ auth()->user()->name ?? old('customer_name') }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="customer_email" class="form-label">Email</label>
                                <input type="email" name="customer_email" id="customer_email" class="form-control" value="{{ auth()->user()->email ?? old('customer_email') }}" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label for="suggested_date" class="form-label">Fecha deseada de entrega (Opcional)</label>
                                <input type="date" name="suggested_date" id="suggested_date" class="form-control" min="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <label for="images" class="form-label">Imágenes de referencia (Opcional)</label>
