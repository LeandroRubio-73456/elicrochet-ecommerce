...
<head>
    @include('layouts.head-page-meta', ['title' => 'Editar Producto: ' . $product->name])
        ...
        <div class="pc-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-4">Editar Producto: {{ $product->name }}</h5>
                            ...
                            <form method="POST" action="{{ route('back.products.update', $product) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="row g-3">
                                                @foreach ([
        'draft' => ['Borrador', 'No visible en tienda', 'warning', 'ti-edit'],
        'active' => ['Activo', 'Visible en tienda', 'success', 'ti-eye'],
        'discontinued' => ['Descontinuado', 'No se fabrica más', 'secondary', 'ti-ban'],
        'archived' => ['Archivado', 'No disponible', 'dark', 'ti-archive'],
                                                        ...
                                                        <div class="form-check card-radio">
                                                            ...
                                                            <label class="form-check-label"
                                                                ...
                                                                <span class="mb-1 d-block fw-bold">
                                                                    <i
                                                                        class="ti {{ $icon }} text-{{ $color }} me-2"></i>
                                                                    {{ $label }}
                                                                </span>
                                                                <span
                                ...
                                <div class="d-flex gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-device-floppy me-2"></i>Actualizar Producto
                                    </button>
                                </div>
                            </form>
                        </div>
