            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-0">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('customer.custom.create') }}" class="list-group-item list-group-item-action text-primary fw-bold {{ request()->routeIs('customer.custom.create') ? 'bg-light-primary' : '' }}">
